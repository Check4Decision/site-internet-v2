...
<main class="px-4 py-28">
    ...
    <section class="text-center mt-20 space-y-10">
        ...
        <div class="grid grid-cols-2 place-items-center gap-6 sm:grid-cols-4">
            ...
            <img class="w-28 h-28" src="/assets/images/ucao.png" alt="Logo Université Catholique de l'Afrique de l'Ouest">
        </div>
    </section>
    ...
    <section class="text-center mt-5 space-y-10">
        ...
        <div class="grid grid-cols-2 place-items-center gap-6 sm:grid-cols-4">
            ...
            <img class="w-28 h-28 filter-grayscale" src="/assets/images/dsi_ut.png" alt="Logo DSI de l'Université de Thiès">
