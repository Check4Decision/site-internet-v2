...
@section('hero')
    ...
    <div class="flex flex-col justify-around items-center min-h-screen">
        <div>
            <h1
                class="text-title sm:text-7xl lg:text-8xl font-koulen text-center bg-clip-text text-transparent bg-gradient-to-r from-sky-900 via-cyan-600 to-sky-900">
                Check4Decision
            </h1>

            <p class="text-sm text-gray-700 font-light text-center mx-auto mt-4 leading-loose tracking-wider sm:text-lg"
...
@section('main')
    ...
    <section class="text-center pt-10 pb-20">
        <div class="mx-auto space-y-24" style="max-width: 50rem;">
            <h2 class="text-4xl sm:text-5xl font-koulen text-sky-900">Consortium</h2>
    ...
    <section class="text-center pt-5 pb-20">
        <div class="mx-auto space-y-10" style="max-width: 50rem;">
            <h2 class="text-gray-400 text-2xl font-koulen">Partenaires</h2>
    ...
    <section class="text-center py-20 px-5 bg-gradient-to-br from-cyan-800 to-sky-800">
        <div class="mx-auto space-y-24" style="max-width: 80rem;">
            <h2 class="text-3xl sm:text-5xl font-koulen text-white">Axes d'intervention</h2>
    ...
    <section class="text-center pt-20 relative bg-gradient-to-br from-transparent via-gray-100 to-white">
        ...
        <h2 class="text-4xl sm:text-5xl font-roboto-slab font-koulen text-sky-900">Equipe</h2>
